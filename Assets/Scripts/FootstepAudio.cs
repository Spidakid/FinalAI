...
public class FootstepAudio : MonoBehaviour
{
    ...
    public float maxSoundRadius = 10f;
    private float distToRadius = 0;//Distance to reach from 0 to 1(max sound radius)
    [Tooltip("The hearing aspect of this object")]
    public Aspect.AspectName hearAspect = Aspect.AspectName.GovForce;
    ...
    private void AddSoundObject()
    {
        ...
        soundObj.GetComponent<HearAspect>().aspect = hearAspect;
    }
    /// <summary>
